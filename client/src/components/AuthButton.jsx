    ...
    <Dialog>
      <DialogTrigger>
        <span className="relative inline-flex overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-zinc-950 opacity-95 px-5 py-2 text-xs md:text-sm font-medium text-white backdrop-blur-3xl">
            <DialogTitle>Login</DialogTitle>
          </span>
        </span>
      </DialogTrigger>
      <DialogContent className="bg-transparent md:p-10">
