...
const App = () => {
  ...
  const devs = [
    { name: "Sourav Pal", linkedin: "https://www.linkedin.com/in/sourav-pal-659631266" },
    { name: "Solanki Singha", linkedin: "https://www.linkedin.com/in/solankisingha" },
    { name: "Sk Nasim Ali", linkedin: "https://www.linkedin.com/in/sk-nasim-ali/" },
    { name: "Trishagni Mondal", linkedin: "https://www.linkedin.com/in/trishagni-mondal-480a5b29a/" },
  ];
      ...
      <div className='h-dvh w-full flex flex-col items-center justify-center'>
        ...
        <div className="flex flex-col items-center text-center text-white px-6 sm:px-10 mt-36 sm:mt-20">
          ...
          <div className="mt-6 flex items-center">
            <img src="https://plus.unsplash.com/premium_photo-1689551670902-19b441a6afde?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="User1" className="w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 border-white " />
            <img src="https://plus.unsplash.com/premium_photo-1689551671548-79ff30459d2a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDd8fHxlbnwwfHx8fHw%3D" alt="User2" className="w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 border-white -ml-3" />
            <img src="https://plus.unsplash.com/premium_photo-1689977807477-a579eda91fa2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="User3" className="w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 border-white -ml-3" />
            <span className="ml-2 md:ml-4 text-[12px] sm:text-sm">Join with 500+ users and start a new experience</span>
          </div>
        ...
        <div className="container flex flex-wrap justify-around items-center border-t border-gray-700 py-8">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <div className="mt-3 flex gap-4 text-lg md:text-xl text-gray-400">
              <a href="https://github.com/solanki03" target="_blank" className="hover:text-white transition-colors"><i className="fab fa-github"></i></a>
              <a href="#" className="hover:text-white transition-colors"><i className="fab fa-linkedin"></i></a>
              <a href="#" className="hover:text-white transition-colors"><i className="fab fa-x-twitter"></i></a>
          ...
          <div className="mb-6 md:mb-0">
            ...
            <ul className="text-gray-400 text-[12px] md:text-sm space-y-1">
              {devs.map((dev, index) => (
                <li key={index}>
                  <a href={dev.linkedin} target="_blank" className="hover:text-white transition-colors cursor-pointer">{dev.name}</a>
                </li>
              ))}
            </ul>
          </div>
            ...
            <div className="grid grid-cols-3 gap-6 text-[12px] md:text-sm">
              {[0, 4, 8].map((startIndex) => (
                <div key={startIndex} className="space-y-1">
                  {topics.slice(startIndex, startIndex + 4).map((topic, index) => (
                    <p key={index}>{topic}</p>
                  ))}
                </div>
              ))}
