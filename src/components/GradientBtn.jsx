...
const GradientBtn = ({name}) => {
    return (
        <button className="relative h-10 px-8 rounded-lg overflow-hidden transition-all duration-500 group">
            ...
            <div className="relative flex items-center justify-center gap-2">
                <span className="text-base font-medium bg-gradient-to-b from-[#D69DDE] to-[#B873F8] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(199,135,246,0.4)] tracking-tighter">
                    {name}
                </span>
            </div>
