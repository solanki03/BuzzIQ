...
export const Card = ({ className, children }) => {
    return (
        <div className={cn("rounded-2xl h-full w-full p-4 overflow-hidden bg-black border border-slate-400/[0.4] group-hover:border-slate-700 relative z-20", className)}>
